/**
 * Create a virtual KSO device
 * Example taken from FooHID example directory
 */
...
#define DEVICE_NAME "keyswitch.one"
...
int main() {
    ...
    create[6] = (uint64_t) 0x1209;  // vendor ID
    create[7] = (uint64_t) 0x5261;  // device ID
